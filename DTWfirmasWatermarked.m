%Script que calcula distancias de las firmas de test a los modelos 
% pero habiendoles añadido una marca de agua previamente
...
disp([' DTW Ident.(%)=',num2str(tasa(point)),' random forgeries DCF_opt=',num2str(DCF_opt(point)),' skilled DCF_opt=',num2str(DCF_optS(point))])
